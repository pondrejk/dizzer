...
filenames = ['biblio_eng.md', 'biblio_cz.md', 'abstracts.md', 'chap0-intro.md', 'chap1-definitions.md', 'chap2-carto_insight.md', 'chap3-vis_challenges.md', 'chap4-case_study_1.md', 'chap5-case_study_2.md', 'chap6-futures.md', 'apx1-carto_research_challenges.md', 'apx2-application1.md', 'apx3-application2.md', 'sources.md']
pwd = os.getcwd()
